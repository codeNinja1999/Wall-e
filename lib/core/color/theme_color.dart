...
import 'package:wall_e/core/color/color_extension.dart';

class ThemeAppColors {
  static final primaryBlue = HexColor("#3154AC");
  ...
  static final primaryDark = Colors.grey[900];
  ...
  static final fillColor = HexColor('#DCD9E0');
}
